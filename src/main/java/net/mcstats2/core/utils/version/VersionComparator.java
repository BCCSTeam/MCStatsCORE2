package net.mcstats2.core.utils.version;
...
final class VersionComparator {
    ...
    static int compareSubversionNumbers(final List<Integer> subversionsA,
                                        final List<Integer> subversionsB) {
    ...
    private static int preReleaseVersion(final String suffix, final int qualifier) {
    ...
    private static int indexOfQualifier(final String suffix, final int qualifier) {
